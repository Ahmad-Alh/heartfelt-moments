  ...
  return (
    <section ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        />
        <p className="text-xl md:text-2xl font-light mb-8">Crafting memories that last a lifetime</p>
        <motion.a
          href={`https://wa.me/+971501661646?text=${encodeURIComponent("Hey, I would like to book!")}`}
          target="_blank"
